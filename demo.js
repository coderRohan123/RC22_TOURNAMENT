...
if (!theName){
  theName="";
  myElement.innerHTML = '<h1>RC22 S5 CHAMPION!!!!!</h1>'
}else{
theNewName = theName.replace(/%20/g, ' '); //oooo a regular exp!
//alert(theNewName);
myElement.innerHTML = '<h1>RC22 SEASON 5 CHAMPION'+theNewName+'!</h1>';
}
//ch = canvas height
...
function newMessage(){
myElement.innerHTML = '<h2 id="canvas">WINNER KISHORE</h2>';
fade_in_button();
}
